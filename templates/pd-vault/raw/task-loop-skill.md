# Task loop (Cursor skill snapshot)

Source: `/Users/perluszdavid/.cursor/skills/task-loop/SKILL.md`
Captured: 2026-09-15
...
**Vault:** `/Users/perluszdavid/SecondBrain/Second Brain` (quote the path).
